# Assignment — Practical Governance Design & Maturity Roadmap

## Konteks kasus

Kirimin memiliki banyak policy tetapi belum ada owner dan workflow. Anda diminta membuat governance operating model minimum untuk dua domain prioritas: orders dan customer tickets.

## Tugas dan requirement

1. Buat domain inventory dan RACI.
2. Definisikan contract untuk dua data product.
3. Nilai maturity saat ini dengan evidence.
4. Buat roadmap 30/60/90 hari, dependency, owner, dan success measure.
5. Sertakan risk register dan proses perubahan schema.

## Kriteria penilaian

- 30% kejelasan decision rights.
- 25% contract dan quality SLO.
- 25% roadmap yang realistis.
- 10% risk register.
- 10% stakeholder fit.
