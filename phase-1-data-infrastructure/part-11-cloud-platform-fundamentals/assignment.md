# Assignment — Cloud Platform Fundamentals

## Konteks kasus

Reza meminta proposal cloud untuk raw data, pipeline, analytical serving, dan API dengan budget guardrail.

## Tugas dan requirement

1. Buat architecture diagram dengan trust boundary.
2. Petakan tiap komponen ke service category dan shared responsibility.
3. Buat IAM role minimum untuk ingestion, transformation, dan analyst.
4. Buat cost model baseline dan sensitivity 3x volume.
5. Definisikan backup, retention, monitoring, dan exit/migration consideration.
