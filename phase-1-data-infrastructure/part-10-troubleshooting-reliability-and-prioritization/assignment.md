# Assignment — Troubleshooting Reliability & Prioritization

## Konteks kasus

Pipeline Kirimin gagal pada tiga titik berbeda: source timeout, quality failure, dan dashboard refresh lambat. Anda menjadi incident owner.

## Tugas dan requirement

1. Buat runbook diagnosis dari symptom ke root cause.
2. Definisikan SLI/SLO untuk freshness, success rate, dan data completeness.
3. Buat retry/timeout/DLQ policy.
4. Prioritaskan lima incident hipotetis dengan alasan.
5. Tulis postmortem satu incident beserta corrective action.

## Kriteria penilaian

- 25% diagnosis reasoning.
- 25% SLO dan measurement.
- 20% resilience design.
- 20% prioritization.
- 10% postmortem quality.
