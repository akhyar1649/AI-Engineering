# Assignment — Data Governance Fundamentals & Quality Management

## Konteks kasus

Data order akan dipakai oleh dashboard dan assistant AI. Dinda meminta quality contract yang dapat menjadi gate sebelum data dikonsumsi.

## Tugas dan requirement

1. Definisikan owner, steward, consumer, classification, dan retention untuk enam tabel persona.
2. Buat minimal 12 expectations lintas completeness, validity, uniqueness, consistency, timeliness, dan integrity.
3. Tetapkan severity serta action untuk setiap failure.
4. Implementasikan minimal enam checks dalam Python atau Great Expectations.
5. Buat contoh validation result dan escalation playbook.

## Kriteria penilaian

- 25% role/policy clarity.
- 30% quality coverage.
- 20% automation.
- 15% severity/action.
- 10% lineage dan dokumentasi.
