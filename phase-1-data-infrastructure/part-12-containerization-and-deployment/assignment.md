# Assignment — Containerization & Deployment

## Konteks kasus

Kirimin perlu API internal untuk quality summary dengan deployment yang dapat dipromosikan dari staging ke production.

## Tugas dan requirement

1. Buat FastAPI service dengan `/health`, `/ready`, dan endpoint summary.
2. Tulis Dockerfile non-root dengan dependency pin dan `.dockerignore`.
3. Buat local compose atau runbook untuk database mock.
4. Definisikan startup, readiness, rollback, resource, dan log policy.
5. Tambahkan test contract tanpa memerlukan credential.

## Kriteria penilaian

- 25% API contract.
- 25% image reproducibility/security.
- 20% health/readiness.
