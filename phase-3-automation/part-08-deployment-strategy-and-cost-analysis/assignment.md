# Assignment — Deployment Strategy & Cost Analysis

## Konteks kasus

Bandingkan n8n cloud, single VPS, dan container platform untuk workflow shipment Kirimin.

## Tugas dan requirement

1. Buat topology diagram dan responsibility matrix.
2. Buat TCO 12 bulan dengan baseline/2x/5x volume.
3. Definisikan backup, upgrade, monitoring, security, dan rollback.
4. Rancang dev/staging/prod promotion.
5. Buat ADR dan rekomendasi.

## Kriteria penilaian

- 25% topology.
- 25% TCO.
- 20% operations/recovery.
