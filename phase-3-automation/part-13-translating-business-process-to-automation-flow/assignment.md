# Assignment — Translating Business Process to Automation Flow

## Konteks kasus

Dokumentasikan proses shipment update as-is dan rancangan to-be.

## Tugas dan requirement

1. Wawancarai atau simulasikan stakeholder Dinda/Sari/Fajar/Reza.
2. Buat process canvas dengan actor, trigger, data, decision, state, SLA, exception.
3. Buat n8n node mapping dan acceptance criteria.
4. Tunjukkan manual handoff yang dipertahankan dan alasannya.
5. Definisikan KPI sebelum/sesudah.
