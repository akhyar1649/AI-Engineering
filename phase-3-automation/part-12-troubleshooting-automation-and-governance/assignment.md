# Assignment — Troubleshooting Automation and Governance

## Konteks kasus

Workflow mengirim duplicate notification dan MCP tool memiliki permission yang salah.

## Tugas dan requirement

1. Buat failure/governance incident taxonomy.
2. Tulis containment, evidence preservation, recovery, dan communication runbook.
3. Definisikan replay/dry-run/rollback/kill switch.
4. Buat change approval/access review workflow.
5. Tulis postmortem dengan corrective action owner.

## Kriteria penilaian

- 25% incident diagnosis.
- 25% safe recovery.
- 20% governance controls.
- 20% runbook/postmortem.
- 10% verification.
