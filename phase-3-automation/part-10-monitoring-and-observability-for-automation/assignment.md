# Assignment — Monitoring & Observability for Automation

## Konteks kasus

Notifikasi customer tidak selalu sampai meski execution n8n success.

## Tugas dan requirement

1. Buat event/trace/audit schema dengan correlation id.
2. Definisikan SLI/SLO dan dashboard minimum.
3. Buat alert dengan severity, owner, runbook, dan dedup.
4. Simulasikan success, retry, partial failure, DLQ, dan duplicate prevented.
5. Tambahkan redaction/retention policy.
