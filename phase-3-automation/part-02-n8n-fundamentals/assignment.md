# Assignment — n8n Fundamentals

## Konteks kasus

Buat workflow webhook untuk shipment event sintetis.

## Tugas dan requirement

1. Buat trigger, validation, decision, action, dan error branch.
2. Gunakan expression untuk membaca payload.
3. Pisahkan credentials dari exported workflow.
4. Tambahkan sample input/output dan correlation id.
5. Dokumentasikan cara test manual dan cara import.

## Kriteria penilaian

- 25% workflow graph.
- 25% data contract.
- 20% credential safety.
- 20% error path.
- 10% documentation.
