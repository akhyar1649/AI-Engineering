# Assignment — Integration Readiness & System Compatibility

## Konteks kasus

Nilai tiga courier partner untuk kesiapan integrasi dan pilih satu untuk pilot.

## Tugas dan requirement

1. Buat readiness scorecard dengan evidence/owner/status.
2. Uji schema/auth/rate limit/webhook/retry/idempotency pada sandbox/mock.
3. Buat adapter atau mapping untuk perbedaan payload.
4. Buat contract tests untuk normal/edge/failure cases.
5. Tulis go/no-go recommendation dan remediation plan.

## Kriteria penilaian

- 25% readiness coverage.
- 25% blocker identification.
- 20% compatibility/adapter.
- 20% contract tests.
- 10% recommendation.
