# Assignment — n8n Reliability

## Konteks kasus

Courier API mengirim duplicate event dan kadang timeout. Workflow harus retry aman dan tidak menggandakan notifikasi.

## Tugas dan requirement

1. Buat failure classification dan retry policy.
2. Implementasikan idempotency store mock.
3. Tambahkan raw persistence, DLQ, replay, dan alert path.
4. Definisikan concurrency/rate-limit policy.
5. Buat SLO dan test matrix.
