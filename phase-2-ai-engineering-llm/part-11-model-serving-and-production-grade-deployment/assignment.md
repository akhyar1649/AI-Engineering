# Assignment — Model Serving & Production-Grade Deployment

## Konteks kasus

Assistant akan dipakai 100 customer support agents pada jam kerja dan harus memiliki route untuk request high-risk dan long-context.

## Tugas dan requirement

1. Buat inference API dengan schema, auth placeholder, health/readiness, timeout, dan error codes.
2. Rancang hosted versus self-hosted decision record.
3. Implementasikan model routing/queue mock.
4. Buat canary, rollback, resource, and rate-limit policy.
5. Buat Docker/runbook tanpa credential.

## Kriteria penilaian

- 25% service contract.
- 25% reliability/scaling.
- 20% security.
