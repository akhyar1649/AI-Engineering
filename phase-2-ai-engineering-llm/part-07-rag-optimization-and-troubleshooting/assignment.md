# Assignment — RAG Optimization & Troubleshooting

## Konteks kasus

RAG assistant hanya menemukan SOP relevan pada sebagian query dan latency meningkat saat top-k dinaikkan.

## Tugas dan requirement

1. Buat labeled evaluation set minimal 30 query dengan relevant document ids.
2. Ukur recall@k, precision@k, MRR, latency, dan token estimate.
3. Bandingkan dua chunk strategy dan satu query rewrite/rerank strategy.
4. Buat troubleshooting report untuk satu retrieval failure dan satu generation failure.
5. Tetapkan regression gate.
