# Assignment — Fine-Tuning Model

## Konteks kasus

Tim ingin meningkatkan intent classification dan gaya jawaban, tetapi SOP berubah rutin. Buat recommendation dan experiment plan.

## Tugas dan requirement

1. Buat taxonomy dan dataset sintetis minimal 200 examples.
2. Lakukan privacy/dedup/label quality review.
3. Bandingkan baseline prompt/RAG dengan fine-tuning plan.
4. Tentukan split, metrics, hard cases, promotion gate, dan rollback.
5. Buat cost/latency estimate dan risk register.
