# Assignment — Cost & Latency Optimization

## Konteks kasus

Volume support meningkat 4x sementara budget tetap. Anda perlu menemukan optimasi tanpa mengurangi safety.

## Tugas dan requirement

1. Buat cost model per route dan per resolved ticket.
2. Ukur p50/p95 latency per stage pada mock pipeline.
3. Bandingkan routing, caching, context compression, dan batching.
4. Tambahkan cache invalidation berdasarkan prompt/SOP/access version.
5. Buat quality/safety guardrail dan budget alert.

## Kriteria penilaian

- 25% cost model.
- 25% latency profiling.
- 20% optimization experiment.
- 20% safety/quality guardrail.
- 10% observability.
