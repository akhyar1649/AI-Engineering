# Assignment — AI and LLM Principle

## Konteks kasus

Fajar ingin assistant yang bisa menjawab FAQ tanpa mengorbankan accuracy. Anda diminta membuat model selection memo dan baseline contract.

## Tugas dan requirement

1. Jelaskan token, context, embedding, inference, temperature, dan hallucination dengan contoh Kirimin.
2. Bandingkan dua model/provider pada quality, latency, cost, context, privacy, dan availability.
3. Buat input/output contract yang menyertakan model id, prompt version, token usage, dan escalation signal.
4. Buat 10 pertanyaan baseline dan expected behavior.

## Kriteria penilaian

- 30% ketepatan konsep.
- 25% model selection reasoning.
- 25% contract/evaluability.
- 20% konteks bisnis dan risk.
