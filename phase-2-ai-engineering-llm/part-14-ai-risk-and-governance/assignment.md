# Assignment — AI Risk and Governance

## Konteks kasus

Kirimin ingin meluncurkan assistant support dengan batasan yang dapat diaudit.

## Tugas dan requirement

1. Buat risk register minimal 12 risiko lintas data/model/product/ops.
2. Definisikan allowed, review-required, dan prohibited use case.
3. Buat privacy/access/retention policy.
4. Buat human oversight dan incident response playbook.
5. Siapkan model/data/system card ringkas.

## Kriteria penilaian

- 25% risk coverage.
- 25% controls/ownership.
- 20% privacy/security.
- 20% oversight/incident.
- 10% documentation.
