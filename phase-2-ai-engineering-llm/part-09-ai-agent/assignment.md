...
Bangun agent support yang dapat memilih tracking, SOP retrieval, atau human handoff.

## Tugas dan requirement

1. Definisikan tool schema dan permission matrix.
2. Implementasikan agent loop dengan max steps, timeout, trace, dan typed result.
3. Tambahkan policy untuk sensitive/irreversible action.
4. Uji tool selection pada minimal 20 scenarios.
5. Bandingkan single-agent workflow dengan multi-agent proposal.
