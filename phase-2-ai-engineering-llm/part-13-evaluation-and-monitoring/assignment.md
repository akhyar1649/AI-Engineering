# Assignment — Evaluation and Monitoring

## Konteks kasus

Setelah release baru, groundedness dan escalation rate berubah. Buat evaluation/monitoring plan yang dapat dipakai mentor.

## Tugas dan requirement

1. Buat evaluation set minimal 40 case lintas risk/intent.
2. Definisikan metric dan release gate.
3. Implementasikan trace schema dan redaction.
4. Buat dashboard/alert specification untuk latency, cost, quality, safety, dan drift.
5. Kalibrasi minimal 10 output dengan human review.
