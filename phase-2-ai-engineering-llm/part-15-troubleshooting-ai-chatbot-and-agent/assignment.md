# Assignment — Troubleshooting AI Chatbot and Agent

## Konteks kasus

Assistant menghasilkan SOP lama, latency tinggi, dan satu trace menunjukkan tool yang salah dipilih.

## Tugas dan requirement

1. Buat failure taxonomy dan triage flow.
2. Buat sanitized trace schema dan reproduction fixture.
3. Tulis runbook untuk retrieval, provider outage, output invalid, tool misuse, dan policy violation.
4. Definisikan rollback/kill switch/canary.
5. Tulis postmortem dan regression tests untuk satu incident.

## Kriteria penilaian

- 25% diagnosis.
- 25% runbook/mitigation.
- 20% trace/privacy.
- 20% regression.
- 10% ownership.
