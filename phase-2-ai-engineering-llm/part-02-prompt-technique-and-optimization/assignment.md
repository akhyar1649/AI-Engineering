# Assignment — Prompt Technique and Optimization

## Konteks kasus

Assistant Fajar kadang menjawab di luar SOP dan tidak konsisten formatnya. Buat prompt contract serta eksperimen optimasi.

## Tugas dan requirement

1. Buat prompt v1 dan v2 dengan system/user/evidence boundary.
2. Tambahkan structured output schema dan fallback ketika evidence kurang.
3. Buat minimal 15 evaluation cases: normal, ambiguous, conflicting, sensitive, injection.
4. Bandingkan output/score dan dokumentasikan perubahan.
5. Pastikan prompt tidak memasukkan secret atau data pelanggan nyata.

## Kriteria penilaian

- 30% prompt clarity.
- 25% safety/injection boundary.
- 25% test set dan comparison.
- 20% output contract.
