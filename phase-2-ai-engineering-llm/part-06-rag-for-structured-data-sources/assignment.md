# Assignment — RAG for Structured Data Sources

## Konteks kasus

Fajar meminta assistant menjawab pertanyaan count, trend, dan status dari database Kirimin serta menggabungkannya dengan SOP.

## Tugas dan requirement

1. Buat intent classifier: document, structured, hybrid, atau human.
2. Buat schema allowlist dan read-only query templates.
3. Implementasikan SQL validation, parameterization, timeout, dan row limit.
4. Gabungkan hasil query dengan citation SOP.
5. Tambahkan test untuk injection, unauthorized table, ambiguous date, dan empty result.
