# Assignment — RAG and LangChain

## Konteks kasus

Buat prototype assistant SOP Fajar dengan retrieval, citation, dan abstention.

## Tugas dan requirement

1. Implementasikan ingestion/chunk/retrieval chain.
2. Gunakan LangChain v1.x atau adapter sendiri dengan boundary yang jelas.
3. Tambahkan citations yang mengarah ke document id/version.
4. Tambahkan fallback jika evidence kosong atau konflik.
5. Simpan trace minimal untuk debugging.

## Kriteria penilaian

- 25% pipeline correctness.
- 25% retrieval/citation.
- 20% abstention/fallback.
- 15% traceability.
- 15% code quality.
